...
const _kPlanets = [
  'assets/planets/planet_1.png',
  'assets/planets/planet_2.png',
  'assets/planets/planet_3.png',
  'assets/planets/planet_4.png',
  'assets/planets/planet_5.png',
  'assets/planets/planet_6.png',
  'assets/planets/planet_7.png',
  'assets/planets/planet_8.png',
];
...
class _AddFriendScreenState extends State<AddFriendScreen> {
  ...
  void _goNext() {
    if (_step < _totalSteps) {
      ...
      // Use the name the user typed, falling back to 'Friend' if empty.
      final name = _nameCtrl.text.trim().isNotEmpty
          ? _nameCtrl.text.trim()
          : 'Friend';
      // Replace this route so Back from the success screen doesn't re-open the form.
          ...
          children: [
            ...
            Positioned(
              ...
              child: _ContinueButton(
                label: _step < _totalSteps ? 'Continue →' : 'Add to orbit',
                showCheck: _step == _totalSteps,
                onTap: _goNext,
              ),
            ),
          ],
  ...
  Widget _buildStepContent() {
    switch (_step) {
      case 1:
        return _Step1(nameCtrl: _nameCtrl, birthdayCtrl: _birthdayCtrl);
      case 2:
        return const _Step2();
      case 3:
        return const _Step3();
...
class _Step1 extends StatelessWidget {
  const _Step1({required this.nameCtrl, required this.birthdayCtrl});
...
class _LabeledBirthdayInputState extends State<_LabeledBirthdayInput> {
  ...
  void _showPicker() {
    ...
    // Default spinner position: 25 years ago (typical adult birthday)
...
class _CalendarIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(
        Offset(0, size.height * 0.45), Offset(size.width, size.height * 0.45), paint);
    canvas.drawLine(
        Offset(size.width * 0.26, 0), Offset(size.width * 0.26, size.height * 0.30), paint);
    canvas.drawLine(
        Offset(size.width * 0.74, 0), Offset(size.width * 0.74, size.height * 0.30), paint);
    ...
    for (var r = 0; r < 2; r++) {
      for (var c = 0; c < 3; c++) {
        canvas.drawCircle(
          Offset(size.width * (0.20 + c * 0.30), size.height * (0.63 + r * 0.22)),
          1.5, dot,
        );
      }
    }
